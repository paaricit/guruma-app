...
export default function OurProgramsTransformationalWorkshopsPage() {
  return (
      ...
      <Container maxWidth={pageContainerMaxWidth} sx={{ ...pageSectionGutterSx }}>
        <Stack spacing={unitScale(14)} sx={{ maxWidth: unitScale(860) }}>
          ...
          <Typography sx={{ color: "text.primary", fontSize: { xs: unitScale(16), md: unitScale(18) }, lineHeight: 1.7 }}>
            This page is the internal route scaffold for Transformational Workshops. You can now add workshop tracks, outcomes, and registration details here.
          </Typography>
          <Box>
