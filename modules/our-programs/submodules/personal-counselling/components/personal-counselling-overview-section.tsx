...
import { personalCounsellingOverviewContent } from "@/modules/our-programs/content/personal-counselling-overview";
            ...
            >
              ...
              >
                ...
                <Stack spacing={1.1} sx={{ mb: 2 }}>
                  <Typography sx={{ fontSize: cardBodyFontSize, color: "guru.coral", fontStyle: "italic", lineHeight: 1.45 }}>
                    {c.isThisForYouRows[0]}
                  </Typography>
                  <Typography sx={{ fontSize: cardBodyFontSize, color: "text.primary", fontStyle: "italic", lineHeight: 1.45 }}>
                    {c.isThisForYouRows[1]} {c.isThisForYouRows[2]}
                  </Typography>
                </Stack>
