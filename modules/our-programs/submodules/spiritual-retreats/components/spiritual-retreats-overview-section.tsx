...
function SpiritualRetreatsIntroVideoDialog({
  open,
  embedSrc,
  onClose
}: {
  ...
  return (
    <Dialog
      ...
      maxWidth="md"
      fullWidth
      aria-label="Spiritual retreats overview video"
      slotProps={{
        paper: {
...
export function SpiritualRetreatsOverviewSection() {
  ...
  return (
    ...
    >
            ...
            >
              ...
              {introVideoSrc ? (
                ...
                >
                  <IconButton
                    type="button"
                    aria-label="Play spiritual retreats overview video"
      ...
      <Box sx={{ position: "absolute", top: "107%", left: 0, right: 0, zIndex: 1, display: { xs: "none", lg: "block" } }}>
        <SectionSoftWaveCap fill="#D1F1F5" height={unitScale(130)} mirror placement="bottom" />
      </Box>

      {introVideoSrc ? (
        <SpiritualRetreatsIntroVideoDialog
          open={introVideoOpen}
