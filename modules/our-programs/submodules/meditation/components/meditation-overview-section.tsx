        ...
        <Stack spacing={{ xs: unitScale(18), md: unitScale(26) }}>
          ...
          <Box sx={{ position: "relative" }}>
            <Box
              sx={{
                display: "grid",
                gridTemplateColumns: { xs: "1fr", md: "0.40fr 0.45fr" },
                justifyContent: "space-between",
                alignItems: "center",
                gap: { xs: 3, md: 4 },
            ...
            >
              <Box
                sx={{
                  position: "relative",
                  width: "100%",
                  minHeight: unitScale(450),
                  height: unitScale(450),
              ...
              >
                <Image
                  src={encodePublicPath("/images/our-programs/meditation-streams.png")}
                  alt="Meditation session in progress"
                  fill
              ...
              <Stack spacing={1.8}>
                ...
                >
                  Didi teaches diverse, powerful practices targeting internal healing and spiritual growth:
                </Typography>
